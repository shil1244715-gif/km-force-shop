...
const revealTargets = document.querySelectorAll(
  '.section-title, .section-desc, .about-card, .feature-item, .product-card, .guestbook-form, .contact-form'
);
  ...
  const revealObserver = new IntersectionObserver(
    (entries, observer) => {
      entries.forEach((entry) => {
        ...
        const group = [...entry.target.parentElement.children].filter((child) =>
